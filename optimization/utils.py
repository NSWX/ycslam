...
def axis_angle_to_matrix(data): # 轴角 -> 旋转矩阵R
...
def matrix_to_axis_angle(rot): # 变换矩阵T -> 轴角
    """
    :param rot: [N, 3, 3]
    :return:
    """
...
def at_to_transform_matrix(rot, trans): # 轴角 -> 变换矩阵T
    """
...
def qt_to_transform_matrix(rot, trans): # 四元数 -> 变换矩阵T
    """
    :param rot: axis-angle [bs, 3]
    :param trans: translation vector[bs, 3]
    :return: transformation matrix [b, 4, 4]
...
def six_t_to_transform_matrix(rot, trans): # 将6D旋转向量和3D平移向量转换为4x4的变换矩阵。
    """
